...
//             <img src={logoImg} alt="ZenX Logo" className="h-12 w-auto" />
...
//             <Button className="bg-[#6633d4] text-white hover:bg-[#6C4EC3] transition-all duration-300 shadow-elegant">
//               Start Your Project
//             </Button>
//           </div>
...
//                 </Link>
//               ))}
//               <Button className="bg-[#7F56D9] text-white hover:bg-[#6C4EC3] transition-all duration-300 shadow-elegant w-full">
//                 Start Your Project
//               </Button>
//             </nav>
//           </div>
